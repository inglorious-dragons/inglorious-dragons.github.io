...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jekyll-sass-converter>.freeze, ["!= 2.0.0", "<= 3.0.0", ">= 1.0"])
      s.add_runtime_dependency(%q<rubyzip>.freeze, ["< 3.0", ">= 1.3.0"])
      ...
      s.add_dependency(%q<jekyll-sass-converter>.freeze, ["!= 2.0.0", "<= 3.0.0", ">= 1.0"])
      s.add_dependency(%q<rubyzip>.freeze, ["< 3.0", ">= 1.3.0"])
